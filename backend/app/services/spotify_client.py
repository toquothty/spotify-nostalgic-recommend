...
class SpotifyClient:
    ...
    def __init__(self):
        ...
        self.scope = "user-library-read user-library-modify user-read-private user-read-email"
    ...
    def get_user_saved_tracks(self, access_token: str, limit: int = 1000, offset: int = 0) -> List[Dict[str, Any]]:
        ...
        while len(tracks) < limit:
            ...
            results = sp.current_user_saved_tracks(limit=current_limit, offset=offset + len(tracks))
    ...
    def search_tracks(self, access_token: str, query: str, limit: int = 20) -> List[Dict[str, Any]]:
        """Search for tracks"""
        sp = self.get_spotify_client(access_token)
